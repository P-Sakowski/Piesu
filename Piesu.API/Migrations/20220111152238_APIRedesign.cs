...
{
    public partial class APIRedesign : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnimalsAttitude = table.Column<int>(type: "int", nullable: false),
                    PeopleAttitude = table.Column<int>(type: "int", nullable: false),
                    ConsideredAggressive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertDog", x => new { x.AdvertsId, x.DogsId });
                    table.ForeignKey(
                        name: "FK_AdvertDog_Adverts_AdvertsId",
                        column: x => x.AdvertsId,
                        principalTable: "Adverts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdvertDog_Dogs_DogsId",
                        column: x => x.DogsId,
                        principalTable: "Dogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
